...
function YJK2addAttachment(){
	var div_parent = $YJK2('<div/>', {style:'margin: 4px; height:120px; padding: 10px; text-align:left;'}).appendTo($K2('#YJK2slider_itemAttachments'));
	...
	var div_image = $YJK2('<div/>', {class:'fltlft'}).appendTo(div_image_row);	
	...
	var input_fltlft = $YJK2('<input/>', {name:'params[YjK2SliderFields][yjk2slider_title]['+photo_id+']', type:'text', id:'YJK2slider_title'+field_id, style:'width:285px;'}).appendTo(div_textarea);	
	...
	var input_fltlft = $YJK2('<textarea>', {name:'params[YjK2SliderFields][yjk2slider_description]['+photo_id+']', type:'text', id:'YJK2slider_description'+field_id, cols:38, rows:3, style:'width: auto!important;'}).appendTo(div_textarea);
