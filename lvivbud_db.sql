...
--
-- Хост: polypr00.mysql.ukraine.com.ua
-- Время создания: Апр 27 2017 г., 16:46
...
CREATE TABLE IF NOT EXISTS `ekiv2_advancedmodules` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_ak_profiles` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_ak_stats` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_ak_storage` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_akeeba_common` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_assets` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_associations` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_banner_clients` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_banner_tracks` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_banners` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ekiv2_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ekiv2_chronoengine_chronoforms` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ekiv2_chronoengine_extensions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ekiv2_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ekiv2_content` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
CREATE TABLE IF NOT EXISTS `ekiv2_content_frontpage` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ekiv2_content_types` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_contentitem_tag_map` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_core_log_searches` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_extensions` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=10048 ;
...
(452, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1493291806}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_filters` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_links` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_links_terms0` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_terms` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ekiv2_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ekiv2_k2_attachments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ekiv2_k2_categories` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_k2_comments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `itemID` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ekiv2_k2_extra_fields` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `value` text NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ekiv2_k2_extra_fields_groups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `ekiv2_k2_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
...
(4, 'Демонтажні роботи', 'demontazhni-roboty', 1, 1, '', '', NULL, NULL, '[]', '', '2017-03-06 10:40:45', 154, '', 0, '0000-00-00 00:00:00', '2017-04-24 15:03:10', 154, '2017-03-06 10:40:45', '0000-00-00 00:00:00', 0, 1, 4, 0, 0, '', '', '', '', 7, '{"YjK2SliderFields":{"showSliderOn":"itemview","disablek2image":"0","disablek2imagecat":"0","slider_width":"100%","slider_height":"355px","stime":"6000","sduration":"600","sorient":"1","type_slider":"0","visibleItems":"2","thumb_resize":"0","autoSlide":"0","sliderLocation":"onK2BeforeDisplayContent","YJK2folder":"SimpleSlide"},"catItemTitle":"","catItemTitleLinked":"","catItemFeaturedNotice":"","catItemAuthor":"","catItemDateCreated":"","catItemRating":"","catItemImage":"","catItemIntroText":"","catItemExtraFields":"","catItemHits":"","catItemCategory":"","catItemTags":"","catItemAttachments":"","catItemAttachmentsCounter":"","catItemVideo":"","catItemVideoWidth":"","catItemVideoHeight":"","catItemAudioWidth":"","catItemAudioHeight":"","catItemVideoAutoPlay":"","catItemImageGallery":"","catItemDateModified":"","catItemReadMore":"","catItemCommentsAnchor":"","catItemK2Plugins":"","itemDateCreated":"","itemTitle":"","itemFeaturedNotice":"","itemAuthor":"","itemFontResizer":"","itemPrintButton":"","itemEmailButton":"","itemSocialButton":"","itemVideoAnchor":"","itemImageGalleryAnchor":"","itemCommentsAnchor":"","itemRating":"","itemImage":"","itemImgSize":"","itemImageMainCaption":"","itemImageMainCredits":"","itemIntroText":"","itemFullText":"","itemExtraFields":"","itemDateModified":"","itemHits":"","itemCategory":"","itemTags":"","itemAttachments":"","itemAttachmentsCounter":"","itemVideo":"","itemVideoWidth":"","itemVideoHeight":"","itemAudioWidth":"","itemAudioHeight":"","itemVideoAutoPlay":"","itemVideoCaption":"","itemVideoCredits":"","itemImageGallery":"","itemNavigation":"","itemComments":"","itemTwitterButton":"","itemFacebookButton":"","itemGooglePlusOneButton":"","itemAuthorBlock":"","itemAuthorImage":"","itemAuthorDescription":"","itemAuthorURL":"","itemAuthorEmail":"","itemAuthorLatest":"","itemAuthorLatestLimit":"","itemRelated":"","itemRelatedLimit":"","itemRelatedTitle":"","itemRelatedCategory":"","itemRelatedImageSize":"","itemRelatedIntrotext":"","itemRelatedFulltext":"","itemRelatedAuthor":"","itemRelatedMedia":"","itemRelatedImageGallery":"","itemK2Plugins":""}', '', 'robots=\nauthor=', '', '', '*'),
(5, 'Послуги із влаштування підлог', 'posluhy-iz-vlashtuvannia-pidloh', 1, 1, '', '', NULL, NULL, '[]', '', '2017-03-06 10:40:59', 154, '', 0, '0000-00-00 00:00:00', '2017-04-24 15:03:21', 154, '2017-03-06 10:40:59', '0000-00-00 00:00:00', 0, 1, 5, 0, 0, '', '', '', '', 8, '{"YjK2SliderFields":{"showSliderOn":"itemview","disablek2image":"0","disablek2imagecat":"0","slider_width":"100%","slider_height":"355px","stime":"6000","sduration":"600","sorient":"1","type_slider":"0","visibleItems":"2","thumb_resize":"0","autoSlide":"0","sliderLocation":"onK2BeforeDisplayContent","YJK2folder":"SimpleSlide"},"catItemTitle":"","catItemTitleLinked":"","catItemFeaturedNotice":"","catItemAuthor":"","catItemDateCreated":"","catItemRating":"","catItemImage":"","catItemIntroText":"","catItemExtraFields":"","catItemHits":"","catItemCategory":"","catItemTags":"","catItemAttachments":"","catItemAttachmentsCounter":"","catItemVideo":"","catItemVideoWidth":"","catItemVideoHeight":"","catItemAudioWidth":"","catItemAudioHeight":"","catItemVideoAutoPlay":"","catItemImageGallery":"","catItemDateModified":"","catItemReadMore":"","catItemCommentsAnchor":"","catItemK2Plugins":"","itemDateCreated":"","itemTitle":"","itemFeaturedNotice":"","itemAuthor":"","itemFontResizer":"","itemPrintButton":"","itemEmailButton":"","itemSocialButton":"","itemVideoAnchor":"","itemImageGalleryAnchor":"","itemCommentsAnchor":"","itemRating":"","itemImage":"","itemImgSize":"","itemImageMainCaption":"","itemImageMainCredits":"","itemIntroText":"","itemFullText":"","itemExtraFields":"","itemDateModified":"","itemHits":"","itemCategory":"","itemTags":"","itemAttachments":"","itemAttachmentsCounter":"","itemVideo":"","itemVideoWidth":"","itemVideoHeight":"","itemAudioWidth":"","itemAudioHeight":"","itemVideoAutoPlay":"","itemVideoCaption":"","itemVideoCredits":"","itemImageGallery":"","itemNavigation":"","itemComments":"","itemTwitterButton":"","itemFacebookButton":"","itemGooglePlusOneButton":"","itemAuthorBlock":"","itemAuthorImage":"","itemAuthorDescription":"","itemAuthorURL":"","itemAuthorEmail":"","itemAuthorLatest":"","itemAuthorLatestLimit":"","itemRelated":"","itemRelatedLimit":"","itemRelatedTitle":"","itemRelatedCategory":"","itemRelatedImageSize":"","itemRelatedIntrotext":"","itemRelatedFulltext":"","itemRelatedAuthor":"","itemRelatedMedia":"","itemRelatedImageGallery":"","itemK2Plugins":""}', '', 'robots=\nauthor=', '', '', '*'),
(6, 'Стелі', 'steli', 1, 1, '', '', NULL, NULL, '[]', '', '2017-03-06 16:10:50', 154, '', 0, '0000-00-00 00:00:00', '2017-03-06 16:11:38', 154, '2017-03-06 16:10:50', '0000-00-00 00:00:00', 0, 1, 6, 0, 0, '', '', '', '', 7, '{"catItemTitle":"","catItemTitleLinked":"","catItemFeaturedNotice":"","catItemAuthor":"","catItemDateCreated":"","catItemRating":"","catItemImage":"","catItemIntroText":"","catItemExtraFields":"","catItemHits":"","catItemCategory":"","catItemTags":"","catItemAttachments":"","catItemAttachmentsCounter":"","catItemVideo":"","catItemVideoWidth":"","catItemVideoHeight":"","catItemAudioWidth":"","catItemAudioHeight":"","catItemVideoAutoPlay":"","catItemImageGallery":"","catItemDateModified":"","catItemReadMore":"","catItemCommentsAnchor":"","catItemK2Plugins":"","itemDateCreated":"","itemTitle":"","itemFeaturedNotice":"","itemAuthor":"","itemFontResizer":"","itemPrintButton":"","itemEmailButton":"","itemSocialButton":"","itemVideoAnchor":"","itemImageGalleryAnchor":"","itemCommentsAnchor":"","itemRating":"","itemImage":"","itemImgSize":"","itemImageMainCaption":"","itemImageMainCredits":"","itemIntroText":"","itemFullText":"","itemExtraFields":"","itemDateModified":"","itemHits":"","itemCategory":"","itemTags":"","itemAttachments":"","itemAttachmentsCounter":"","itemVideo":"","itemVideoWidth":"","itemVideoHeight":"","itemAudioWidth":"","itemAudioHeight":"","itemVideoAutoPlay":"","itemVideoCaption":"","itemVideoCredits":"","itemImageGallery":"","itemNavigation":"","itemComments":"","itemTwitterButton":"","itemFacebookButton":"","itemGooglePlusOneButton":"","itemAuthorBlock":"","itemAuthorImage":"","itemAuthorDescription":"","itemAuthorURL":"","itemAuthorEmail":"","itemAuthorLatest":"","itemAuthorLatestLimit":"","itemRelated":"","itemRelatedLimit":"","itemRelatedTitle":"","itemRelatedCategory":"","itemRelatedImageSize":"","itemRelatedIntrotext":"","itemRelatedFulltext":"","itemRelatedAuthor":"","itemRelatedMedia":"","itemRelatedImageGallery":"","itemK2Plugins":""}', '', 'robots=\nauthor=', '', '', '*'),
...
(8, 'Укладка плитки', 'ukladka-plytky', 1, 1, '', '', NULL, NULL, '[]', '', '2017-03-06 16:12:13', 154, '', 0, '0000-00-00 00:00:00', '2017-03-06 16:12:35', 154, '2017-03-06 16:12:13', '0000-00-00 00:00:00', 0, 1, 8, 0, 0, '', '', '', '', 3, '{"catItemTitle":"","catItemTitleLinked":"","catItemFeaturedNotice":"","catItemAuthor":"","catItemDateCreated":"","catItemRating":"","catItemImage":"","catItemIntroText":"","catItemExtraFields":"","catItemHits":"","catItemCategory":"","catItemTags":"","catItemAttachments":"","catItemAttachmentsCounter":"","catItemVideo":"","catItemVideoWidth":"","catItemVideoHeight":"","catItemAudioWidth":"","catItemAudioHeight":"","catItemVideoAutoPlay":"","catItemImageGallery":"","catItemDateModified":"","catItemReadMore":"","catItemCommentsAnchor":"","catItemK2Plugins":"","itemDateCreated":"","itemTitle":"","itemFeaturedNotice":"","itemAuthor":"","itemFontResizer":"","itemPrintButton":"","itemEmailButton":"","itemSocialButton":"","itemVideoAnchor":"","itemImageGalleryAnchor":"","itemCommentsAnchor":"","itemRating":"","itemImage":"","itemImgSize":"","itemImageMainCaption":"","itemImageMainCredits":"","itemIntroText":"","itemFullText":"","itemExtraFields":"","itemDateModified":"","itemHits":"","itemCategory":"","itemTags":"","itemAttachments":"","itemAttachmentsCounter":"","itemVideo":"","itemVideoWidth":"","itemVideoHeight":"","itemAudioWidth":"","itemAudioHeight":"","itemVideoAutoPlay":"","itemVideoCaption":"","itemVideoCredits":"","itemImageGallery":"","itemNavigation":"","itemComments":"","itemTwitterButton":"","itemFacebookButton":"","itemGooglePlusOneButton":"","itemAuthorBlock":"","itemAuthorImage":"","itemAuthorDescription":"","itemAuthorURL":"","itemAuthorEmail":"","itemAuthorLatest":"","itemAuthorLatestLimit":"","itemRelated":"","itemRelatedLimit":"","itemRelatedTitle":"","itemRelatedCategory":"","itemRelatedImageSize":"","itemRelatedIntrotext":"","itemRelatedFulltext":"","itemRelatedAuthor":"","itemRelatedMedia":"","itemRelatedImageGallery":"","itemK2Plugins":""}', '', 'robots=\nauthor=', '', '', '*'),
...
CREATE TABLE IF NOT EXISTS `ekiv2_k2_rating` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_k2_tags` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `published` smallint(6) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `ekiv2_k2_tags_xref` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ekiv2_k2_user_groups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ekiv2_k2_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userID` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ekiv2_languages` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ekiv2_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ekiv2_messages` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_messages_cfg` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
(114, 94, 'РЕАЛІЗОВАНІ ПРОЕКТИ BM', '', '', 0, 'realized', 154, '2017-04-27 12:26:40', '2017-04-18 13:42:00', '0000-00-00 00:00:00', 1, 'mod_bm_slider_for_k2', 1, 1, '{"source":"filter","catfilter":"1","category_id":["2"],"getChildren":"0","itemCount":"5","itemsOrdering":"","FeaturedItems":"1","popularityRange":"","item":"0","itemImgSize":"Small","addLinkToImage":"0","theme":"theme1","width_image":"150","height_image":"150","resize_type":"5","title_limit":"100","readmore_limit":"300","show_desc":"1","show_readmore":"1","readmore_label":"More detail","timeout":"30000","visible":"3","starting_slide":"1","effect":"carousel","pause_on_hover":"0","responsive":"1","swipe":"1","random":"0","show_paging":"1","jquery":"0","layout":"_:theme1","moduleclass_sfx":" realized_projects","cache":"0","cache_time":"0","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"div","header_class":"module_title h2","style":"0"}', 0, '*'),
...
CREATE TABLE IF NOT EXISTS `ekiv2_modules_menu` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ekiv2_overrider` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_postinstall_messages` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ekiv2_schemas` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_session` (
...
('59lktqsi87ldm9mdnumub7k8p5', 0, 1, '1493300534', 'gcore|a:3:{s:16:"acos_permissions";N;s:4:"user";a:9:{s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:10:"last_login";N;s:9:"logged_in";b:0;s:5:"guest";i:1;s:6:"groups";a:1:{i:0;s:1:"9";}s:11:"inheritance";a:2:{i:0;s:1:"1";i:1;s:1:"0";}}s:9:"__FLASH__";N;}joomla|s:508:"";', 0, '');
...
CREATE TABLE IF NOT EXISTS `ekiv2_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ekiv2_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ekiv2_ucm_base` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_ucm_content` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_ucm_history` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_update_sites` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Update Sites' AUTO_INCREMENT=13 ;
...
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1493279127, ''),
(2, 'Joomla! Extension Directory', 'collection', 'https://update.joomla.org/jed/list.xml', 1, 1493279127, ''),
...
(10, 'Chronoforms v5 update server', 'extension', 'http://www.chronoengine.com/chrono_joomla_updates/chronoforms5.xml', 1, 1493279127, ''),
(11, 'Regular Labs - Advanced Module Manager', 'extension', 'http://download.regularlabs.com/updates.xml?e=advancedmodulemanager&pro=1&type=.xml', 1, 1493279127, ''),
(12, 'BM Slider For K2 Update Site', 'extension', 'http://brainymore.com/update_modules/free/k2/bm_slider_for_k2_update.xml', 1, 1493279128, '');
...
CREATE TABLE IF NOT EXISTS `ekiv2_update_sites_extensions` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_updates` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Available Updates' AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `ekiv2_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ekiv2_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ekiv2_user_profiles` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_user_usergroup_map` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
CREATE TABLE IF NOT EXISTS `ekiv2_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(154, 'Super User', 'admin-gw', 'pr@greenweb.com.ua', '$2y$10$zPTcqyb/8ZNL3QagnJTIZe803XBYQR0M41QhBhCrTWh1A5/Ag1Ed6', 0, 1, '2017-01-25 08:11:56', '2017-04-27 12:26:18', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);
...
CREATE TABLE IF NOT EXISTS `ekiv2_utf8_conversion` (
...
CREATE TABLE IF NOT EXISTS `ekiv2_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.',
...
CREATE TABLE IF NOT EXISTS `ekiv2_yj_k2_slider` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
